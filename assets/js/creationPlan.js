     ...
     */
     function updateRecetteLundi() {
      ...
      for (let i = 0; i < tableauRecettesLundi.length; i++) {
        ...
        aAfficher.innerHTML = "<div class='popup-content'><div class='left-column'><img class='recipe-image' src='"+imgSrc+"' alt='Recipe Image'><p class='recipe-description'>"+tableauRecettesLundi[i].description+"</p></div><div class='right-column'><div class='ingredients-box'><h2 class='ingredients-title'>DÉTAILS</h2><div class='recipe-info-section'><h3 class='info-title'>NOMBRE DE PORTIONS</h3><p class='info-value'>"+tableauRecettesLundi[i].portions+" Portions</p></div><div class='recipe-info-section'><h3 class='info-title'>TEMPS DE PRÉPARATION</h3><p class='info-value'>"+tableauRecettesLundi[i].temps_de_cuisson+" Minutes</p></div><div class='recipe-info-section'><h3 class='info-title'>NOMBRE D'INGRÉDIENTS</h3><p class='info-value'>"+tableauRecettesLundi[i].nombre_ingredients+" Portions</p></div><div class='recipe-info-section'><h3 class='info-title'>NOMBRE D'ÉTAPES</h3><p class='info-value'>"+tableauRecettesLundi[i].nombre_etapes+" Etapes</p></div></div></div></div>";
     ...
     */
     function updateRecetteMardi() {
      ...
      for (let i = 0; i < tableauRecettesMardi.length; i++) {
        ...
        aAfficher.innerHTML = "<div class='popup-content'><div class='left-column'><img class='recipe-image' src='"+imgSrc+"' alt='Recipe Image'><p class='recipe-description'>"+tableauRecettesMardi[i].description+"</p></div><div class='right-column'><div class='ingredients-box'><h2 class='ingredients-title'>DÉTAILS</h2><div class='recipe-info-section'><h3 class='info-title'>NOMBRE DE PORTIONS</h3><p class='info-value'>"+tableauRecettesMardi[i].portions+" Portions</p></div><div class='recipe-info-section'><h3 class='info-title'>TEMPS DE PRÉPARATION</h3><p class='info-value'>"+tableauRecettesMardi[i].temps_de_cuisson+" Minutes</p></div><div class='recipe-info-section'><h3 class='info-title'>NOMBRE D'INGRÉDIENTS</h3><p class='info-value'>"+tableauRecettesMardi[i].nombre_ingredients+" Portions</p></div><div class='recipe-info-section'><h3 class='info-title'>NOMBRE D'ÉTAPES</h3><p class='info-value'>"+tableauRecettesMardi[i].nombre_etapes+" Portions</p></div></div></div></div>";
     ...
     */
     function updateRecetteJeudi() {
      ...
      for (let i = 0; i < tableauRecettesJeudi.length; i++) {
        ...
        aAfficher.innerHTML = "<div class='popup-content'><div class='left-column'><img class='recipe-image' src='"+imgSrc+"' alt='Recipe Image'><p class='recipe-description'>"+tableauRecettesJeudi[i].description+"</p></div><div class='right-column'><div class='ingredients-box'><h2 class='ingredients-title'>DÉTAILS</h2><div class='recipe-info-section'><h3 class='info-title'>NOMBRE DE PORTIONS</h3><p class='info-value'>"+tableauRecettesJeudi[i].portions+" Portions</p></div><div class='recipe-info-section'><h3 class='info-title'>TEMPS DE PRÉPARATION</h3><p class='info-value'>"+tableauRecettesJeudi[i].temps_de_cuisson+" Minutes</p></div><div class='recipe-info-section'><h3 class='info-title'>NOMBRE D'INGRÉDIENTS</h3><p class='info-value'>"+tableauRecettesJeudi[i].nombre_ingredients+" Portions</p></div><div class='recipe-info-section'><h3 class='info-title'>NOMBRE D'ÉTAPES</h3><p class='info-value'>"+tableauRecettesJeudi[i].nombre_etapes+" Portions</p></div></div></div></div>";
     ...
     */
     function updateRecetteVendredi() {
      ...
      for (let i = 0; i < tableauRecettesVendredi.length; i++) {
        ...
        aAfficher.innerHTML = "<div class='popup-content'><div class='left-column'><img class='recipe-image' src='"+imgSrc+"' alt='Recipe Image'><p class='recipe-description'>"+tableauRecettesVendredi[i].description+"</p></div><div class='right-column'><div class='ingredients-box'><h2 class='ingredients-title'>DÉTAILS</h2><div class='recipe-info-section'><h3 class='info-title'>NOMBRE DE PORTIONS</h3><p class='info-value'>"+tableauRecettesVendredi[i].portions+" Portions</p></div><div class='recipe-info-section'><h3 class='info-title'>TEMPS DE PRÉPARATION</h3><p class='info-value'>"+tableauRecettesVendredi[i].temps_de_cuisson+" Minutes</p></div><div class='recipe-info-section'><h3 class='info-title'>NOMBRE D'INGRÉDIENTS</h3><p class='info-value'>"+tableauRecettesVendredi[i].nombre_ingredients+" Portions</p></div><div class='recipe-info-section'><h3 class='info-title'>NOMBRE D'ÉTAPES</h3><p class='info-value'>"+tableauRecettesVendredi[i].nombre_etapes+" Portions</p></div></div></div></div>";
