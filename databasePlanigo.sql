...
>>>>>>> ced86833b42bbd1d247367bf1f3918d973bb0bb6
);
...
INSERT INTO Recettes (nom, description, type, temps_de_cuisson, image, createur_nom_utilisateur, portions)
VALUES
    ('Salade César', 'Une salade avec du poulet, de la laitue et de la sauce César', 'Dîner', 15, NULL, 'john_doe', 2),
    ('Spaghetti Bolognese', 'Des pâtes avec une sauce bolognaise savoureuse', 'Plat principal' , 30, NULL, 'jane_doe', 4),
    ('Soupe à loignon', 'Une soupe chaude avec des oignons caramelises', 'Entrée', 45, NULL, 'alice_smith',2);
